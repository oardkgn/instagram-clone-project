...
const GetIcon = ({ name, size = 24, width = 2 }) => {
  const icons = {
    instagram: textLogo,
    home: homeIcon,
    ...
    create: createIcon,
    notify: notifIcon,
    yourMsg: yourMessageIcon,
    msg: messageIcon,
    msgActive: messageIconActive,
    reels: reelsIcon,
    explore: exploreIcon,
    search: searchIcon,
    menu: menuIcon,
    ...
    theme: themeIcon,
    saved: savedLogo,
    activity: activiyLogo,
    settings: settingLogo,
    tagged: taggedIcon,
    posts: postsIcon,
    downArrow: downArrowIcon,
    createMsg: createMsgIcon,
    ...
    dots: dotsIcon,
    comment: commentIcon,
    addFriend: addFriendsIcon,
  };

  const Component = icons[name];
  return <Component size={size} width={width} />;
};
