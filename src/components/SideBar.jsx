        ...
        <ul className="pt-6 px-3 flex flex-col flex-shrink-0 gap-2">
          ...
          <li>
            <button
              ...
              className={`w-full group hover:bg-gray-100 transition-all px-3 items-center ${searchBar && "border"}  py-3 rounded-md flex gap-4`}
            >
              <div className=" -ml-[1px] group-hover:scale-105 transition-all">
                <GetIcon name="search" />
              </div>
          ...
          <li>
            ...
            >
              ...
              {!searchBar && <span className=" hidden xl:block">Messages</span>}
            </a>
          </li>
          <li>
            <a
